...
function add_borrower_form() {
  ...
  div.innerHTML =
    ...
    '<input type="radio" id="borrower-legal-radio-' +
    borrowerForms +
    '" name="borrower-radio-' +
    borrowerForms +
    '" checked />' +
    '<label for="borrower-legal-radio-' +
    borrowerForms +
    '" id="borrower-legal-radio-' +
    borrowerForms +
    "\" onclick=\"toggleFormBorrower('borrower-legal', 'borrower-legal-radio-" +
    borrowerForms +
    "')\">Legal Entity</label>" +
    '<div class="custom-radio"></div>' +
    "</div>" +
    '<div class="individual field">' +
    '<input type="radio" id="borrower-individual-radio-' +
    borrowerForms +
    '" name="borrower-radio-' +
    borrowerForms +
    '" />' +
    '<label for="borrower-individual-radio-' +
    borrowerForms +
    '" id="borrower-individual-radio-' +
    borrowerForms +
    "\" onclick=\"toggleFormBorrower('borrower-individual','borrower-individual-radio-" +
    borrowerForms +
    "')\">Individual" +
    "</label>" +
    '<div class="custom-radio"></div>' +
    "</div>" +
    "</div>" +
    '<form id="borrower-legal-form-' +
    borrowerForms +
    '" class="legal-form">' +
    '<p for="">Company Name</p>' +
    '<input type="text" placeholder="Company Name" name="companyName' +
    borrowerForms +
    '" onKeyUp="inputHandler(event)0 "value="" required />' +
    '<p for="">Registered Address</p>' +
    '<input type="text" placeholder="Registered Address" onKeyUp="inputHandler(event)" name="registeredAddress' +
    borrowerForms +
    '" value="" required />' +
    '<p for="">Registration Number</p>' +
    '<input type="text" placeholder="Registration Number" onKeyUp="inputHandler(event)" name="registrationNumber' +
    borrowerForms +
    '" value="" required />' +
    '<p for="">Registration Country</p>' +
    '<select name="registrationCountry' +
    borrowerForms +
    '" onchange="inputHandler(event)" required>' +
    ...
    "</select>" +
    '<p for="">Defined as...</p>' +
    '<input type="text" placeholder="Defined as..." onKeyUp="inputHandler(event)" name="definedAs' +
    borrowerForms +
    '" value="" required />' +
    "</form>" +
    '<form id="borrower-individual-form-' +
    borrowerForms +
    ...
    '</form><button class="removebtn" type="button" onclick="remove_borrower_form(' +
    borrowerForms +
